  ...
  app: {
    head: {
      ...
      script: [
        {
          innerHTML:
            "(function(){try{var t=localStorage.getItem('urban-snap-theme');if(t==='light'||t==='dark')document.documentElement.setAttribute('data-theme',t);}catch(e){}})();",
          tagPosition: 'head',
        },
      ],
      link: [
      ...
      meta: [
        ...
        { name: 'theme-color', content: '#f5f3ef', media: '(prefers-color-scheme: light)' },
